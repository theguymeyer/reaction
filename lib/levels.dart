...
class Levels {
  ...
  List<Level> _levels = [
    Level(1, 5, Offset(4, 20), Offset(1,17), 700, 0.05, 4), // high variance Size and Speed
    Level(2, 10, Offset(2, 15), Offset(0.2, 7.5), 2000, 0.1, 10), // fun level
    Level(3, 30, Offset(3, 10), Offset(3.5, 5.5), 1000, 0.1, 10),
    // Level(2, 20, 0.3),
    // Level(3, 20, 0.5),
    // Level(4, 20, 0.7),
    // Level(5, 20, 0.8),
